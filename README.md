...
-[:link:] **TESTES PARAMÉTRICOS E REGRESSÃO LINEAR PARA TAXA DE OCUPAÇÃO DE IMÓVEIS**(https://github.com/pedrocecere/Portifolio_Regressao_Linear_Testes_Parametricos.git)
